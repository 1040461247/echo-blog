...
const ArticleComments: FC<IProps> = memo(() => {
  ...
  return (
    <div className="article-comments">
      ...
      <div className="article-comments-content m-2 p-2 bg-[--bg-dark-blue-deep] rounded-xl border border-gray-600 hover:border-gray-500 transition-color duration-300">
        <textarea
